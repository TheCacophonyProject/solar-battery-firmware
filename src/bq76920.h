...
// This will set the minimum cell voltage to the highest possible value to make
// it easier testing the low cell voltage threshold.
#define TEST_MINIMUM_CELL_VOLTAGE false

// This will set the maximum cell voltage to the lowest possible value to make
// it easier testing the high cell voltage threshold.
